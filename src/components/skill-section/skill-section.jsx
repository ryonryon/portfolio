...
class SkillSection extends React.Component {
  render = () => (
    <section id="skill-section-id" className="skill-section">
      <div className="skill-pane">
        ...
        <SkillSet
          ...
          skillName="HTML5"
        />
        <SkillSet skillLogoSrc="/assets/tech-logo/css-3.svg" skillName="CSS" />
        <SkillSet
        ...
        <SkillSet
          ...
          skillName="Nodejs"
        />
        <SkillSet skillLogoSrc="/assets/tech-logo/dart.svg" skillName="Dart" />
        <SkillSet
        ...
        <SkillSet
          ...
          skillName="Python"
        />
        <SkillSet skillLogoSrc="/assets/tech-logo/java.svg" skillName="Java" />
        <SkillSet skillLogoSrc="/assets/tech-logo/c-sharp.svg" skillName="C#" />
        <SkillSet
